...
{strip}
	<!--FORM FOR COUNTING-->
	<div class="fr row" id="fr">
		<form class="col-8 col-md-2" method="post" action="/modules/Cars/views/cars_view.php">
			<p>From: <input class="form-control" type="date" name="start"/></p>
			<p>To: <input class="form-control" type="date" name="end"/></p>
			<p><button class="btn btn-primary" type="submit">Oblicz</button></p>
		</form>
	</div>
