...
class OSSMailScanner
{
	...
	/**
	 * Do you want to attach graphic files from the email body as documents: From Base64 src='data:image/jpeg;base64, ...... ?
	 * @var bool When the option is disabled, graphic files aren't saved in the CRM
	 */
	public static $attachMailBodyGraphicBase64 = true;

	/**
	 * Do you want to attach graphic files from the email body as documents: src=cid:part1... ?
	 * @var bool When the option is disabled, graphic files aren't saved in the CRM
	 */
	public static $attachMailBodyGraphicCid = true;
